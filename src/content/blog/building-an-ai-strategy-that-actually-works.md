...
1. Identify high-value, high-friction business processes
2. Assess which of those have data assets to support automation or augmentation
3. Then — and only then — evaluate technology options
